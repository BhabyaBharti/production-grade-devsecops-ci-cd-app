...
connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:envsqlserver.database.windows.net,1433;Database=envsqldb;Uid=sqlappusercai123;Pwd=sqlappusercai@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000"],  # This allows all origins (use '*' for development only)
